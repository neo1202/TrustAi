...
function ShapPage() {
  ...
  const handleInputXSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:5000/api/process_cf', {
        inputX,
        desired_y,
      });
  ...
  const handleShapSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:5000/api/process_shapClassPlot', {
        shapClass,
  ...
  const handleShapDepSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:5000/api/process_depClassPlot', {
        depClass1,
        depClass2,
        depY
      });
  ...
  return (
    <div style={pageStyle}>
      ...
      <div id="shap-page" className="section">
        ...
        <img src={`http://127.0.0.1:5000/api/get-plot-image/all_class.png`} alt="Generated Plot" />
        ...
        {imagePath && (
          <div>
            ...
            <div className="image-container">
              <img src={`http://127.0.0.1:5000/api/get-plot-image/${imagePath}`} alt="Generated Plot" />
              <img src={`http://127.0.0.1:5000/api/get-plot-image/${gBarImagePath}`} alt="Generated Plot" />
            ...
            <div className="image-container">
              ...
              <img src={`http://127.0.0.1:5000/api/get-plot-image/${gPieImagePath}`} alt="Generated Plot" />
              </div>
          </div>
        )}
...
positive value means positive effect and negative value means neagative effect ON a class.  
        ...
        {imagePathD1 && (
          <div>
            ...
            {/* console.log(imagePath) */}
            <div className="image-container">
              <img src={`http://127.0.0.1:5000/api/get-plot-image/${imagePathD1}`} alt="Generated Plot" />
              <img src={`http://127.0.0.1:5000/api/get-plot-image/${imagePathD2}`} alt="Generated Plot" />
            </div>
          </div>
        )}
